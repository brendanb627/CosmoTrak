...
import earthBeefy from "../Sub-Components/earthbeefy.jpg"
...
// Earth Component
const Earth = ({ scale }) => {
  const texture = useLoader(THREE.TextureLoader, earthBeefy);
  ...
  return (
    <>
      ...
      {currentAsteroid && (
        ...
        speed={
          currentAsteroid.close_approach_data[0]?.relative_velocity.kilometers_per_hour
        }
